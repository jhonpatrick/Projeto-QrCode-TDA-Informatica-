...
public final class PreferencesFragment extends PreferenceFragment implements
	...
	public void onCreate(Bundle icicle) {
		...
		decode1D = (CheckBoxPreference) preferences
				.findPreference(PreferencesActivity.KEY_DECODE_1D);
		decodeQR = (CheckBoxPreference) preferences
				.findPreference(PreferencesActivity.KEY_DECODE_QR);
		decodeDataMatrix = (CheckBoxPreference) preferences
				.findPreference(PreferencesActivity.KEY_DECODE_DATA_MATRIX);
