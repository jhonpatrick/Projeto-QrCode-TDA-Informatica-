...
public abstract class SupplementalInfoRetriever extends
	...
	public static void maybeInvokeRetrieval(TextView textView,
		...
		if (result instanceof URIParsedResult) {
			...
			String normalizedProductID = productParsedResult
			...
			case 12:
				SupplementalInfoRetriever upcInfoRetriever = new AmazonInfoRetriever(
						textView, "UPC", normalizedProductID, historyManager,
						context);
				upcInfoRetriever
						.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
				break;
			case 13:
				SupplementalInfoRetriever eanInfoRetriever = new AmazonInfoRetriever(
						textView, "EAN", normalizedProductID, historyManager,
						context);
				eanInfoRetriever
						.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
				break;
			...
			SupplementalInfoRetriever amazonInfoRetriever = new AmazonInfoRetriever(
					textView, "ISBN", isbn, historyManager, context);
			amazonInfoRetriever
					.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
		}
	}
